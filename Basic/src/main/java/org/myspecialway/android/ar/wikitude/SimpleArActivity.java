...
import org.myspecialway.android.ar.wikitude.utils.DefaultConfigs;
import org.myspecialway.android.ar.wikitude.utils.SampleData;
...
public class SimpleArActivity extends AppCompatActivity {
    ...
    private static final String SAMPLES_ROOT = "ar/wikitude/";
...
//        final SampleData sampleData = (SampleData) intent.getSerializableExtra(INTENT_EXTRAS_KEY_SAMPLE);
        final SampleData sampleData = new SampleData.Builder("AR.Wikutude POI", "index.html")
                .activityClass(org.myspecialway.android.ar.wikitude.SimpleGeoArActivity.class)
                .extensions(new ArrayList<String>())
                .arFeatures(DefaultConfigs.DEFAULT_AR_FEATURES)
                .cameraPosition(CameraSettings.CameraPosition.BACK)
                .cameraResolution(CameraSettings.CameraResolution.AUTO)
                .camera2Enabled(DefaultConfigs.DEFAULT_CAMERA_2_ENABLED)
                .build();
